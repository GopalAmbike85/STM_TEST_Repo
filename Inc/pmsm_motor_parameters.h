...
#define POLE_PAIR_NUM           1    /* Maxon ECX Speed 10M: 1 pole pair */
#define RS                      17.1 /* Stator resistance, ohm (Wye) */
#define LS                      0.0001 /* Stator inductance, H (100 uH) */
...
#define MOTOR_VOLTAGE_CONSTANT  0.50 /*!< Volts RMS ph-ph /kRPM (KV=1650 RPM/V) */
#define MOTOR_MAX_SPEED_RPM     10000 /*!< Maximum rated speed  */
#define NOMINAL_CURRENT_A       0.40  /* 0.356A nominal + margin */

#define ID_DEMAG_A              -0.40 /*!< Demagnetization current */
